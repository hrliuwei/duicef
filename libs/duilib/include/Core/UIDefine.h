...
#define DUI_MSGTYPE_RHCLICK                (_T("rhclick"))
...
#define DUI_MSGTYPE_MOUSE_ENTER			   (_T("mouseenter"))
...
//定义click消息的控件名称--执行函数宏 鼠标双击
#define DUI_ON_DBCLICK_CTRNAME(ctrname,memberFxn)                          \
{ DUI_MSGTYPE_DBCLICK, ctrname, DuiSig_vn, (DUI_PMSG)&memberFxn },			\

//定义click消息的控件名称--执行函数宏 鼠标右击
#define DUI_ON_RHCLICK_CTRNAME(ctrname,memberFxn)                          \
{ DUI_MSGTYPE_RHCLICK, ctrname, DuiSig_vn, (DUI_PMSG)&memberFxn },			\
